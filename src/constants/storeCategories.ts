...
export const CATEGORY_CONFIGS: Record<string, CatConfig> = {
  'All Categories': {
    featuredTitle: 'Featured on SwapShop',
  ...
  restaurant: {
    ...
    banners: [
      ...
      { title: '100% barter restaurants', sub: 'Pay entirely with SwapShop credits', cta: 'Browse', bg: 'bg-red-600', imgBg: 'bg-red-500', expires: 'Limited spots' },
  ...
  retail: {
    ...
    banners: [
      ...
      { title: 'Exclusive retail deals', sub: 'Members get early access', cta: 'Join Free', bg: 'bg-indigo-600', imgBg: 'bg-indigo-500', expires: 'SwapShop+ only' },
  ...
  service: {
    ...
    banners: [
      { title: 'Hire local, pay with credits', sub: 'Book services using SwapShop credits', cta: 'Browse Services', bg: 'bg-purple-600', imgBg: 'bg-purple-500', expires: 'Ongoing' },
  ...
  health: {
    ...
    banners: [
      ...
      { title: 'Mental wellness deals', sub: 'Therapy & coaching with SwapShop', cta: 'Explore', bg: 'bg-pink-600', imgBg: 'bg-pink-500', expires: 'Limited slots' },
  ...
  beauty: {
    ...
    banners: [
      { title: 'Glow up with credits', sub: 'Salons & spas accept SwapShop', cta: 'Book Now', bg: 'bg-pink-500', imgBg: 'bg-pink-400', expires: 'Ongoing' },
  ...
  fitness: {
    ...
    banners: [
      { title: 'Train now, pay with credits', sub: 'Gyms & studios on SwapShop', cta: 'Find a Gym', bg: 'bg-orange-600', imgBg: 'bg-orange-500', expires: 'Ongoing' },
  ...
  mechanic: {
    ...
    banners: [
      { title: 'Car repairs with credits', sub: 'Trusted mechanics on SwapShop', cta: 'Find Mechanic', bg: 'bg-slate-600', imgBg: 'bg-slate-500', expires: 'Ongoing' },
  ...
  lawyer: {
    ...
    banners: [
      { title: 'Legal help, barter style', sub: 'Consult lawyers with SwapShop credits', cta: 'Find a Lawyer', bg: 'bg-slate-700', imgBg: 'bg-slate-600', expires: 'Ongoing' },
  ...
  tutor: {
    ...
    banners: [
      { title: 'Learn more, pay less', sub: 'Tutors & courses with SwapShop credits', cta: 'Find a Tutor', bg: 'bg-sky-600', imgBg: 'bg-sky-500', expires: 'Ongoing' },
  ...
  photographer: {
    ...
    banners: [
      { title: 'Capture moments with credits', sub: 'Book photographers on SwapShop', cta: 'Book Now', bg: 'bg-amber-700', imgBg: 'bg-amber-600', expires: 'Ongoing' },

...
export const FILTER_CHIPS = [
  { label: 'Valuehub Exchange+',   value: 'premium' },
...
export const CATEGORY_CONFIGS: Record<string, CatConfig> = {
  'All Categories': {
    featuredTitle: 'Featured on Valuehub Exchange',
  ...
  restaurant: {
    ...
    banners: [
      ...
      { title: '100% barter restaurants', sub: 'Pay entirely with Valuehub Exchange credits', cta: 'Browse', bg: 'bg-red-600', imgBg: 'bg-red-500', expires: 'Limited spots' },
  ...
  retail: {
    ...
    banners: [
      ...
      { title: 'Exclusive retail deals', sub: 'Members get early access', cta: 'Join Free', bg: 'bg-indigo-600', imgBg: 'bg-indigo-500', expires: 'Valuehub Exchange+ only' },
  ...
  service: {
    ...
    banners: [
      { title: 'Hire local, pay with credits', sub: 'Book services using Valuehub Exchange credits', cta: 'Browse Services', bg: 'bg-purple-600', imgBg: 'bg-purple-500', expires: 'Ongoing' },
  ...
  health: {
    ...
    banners: [
      ...
      { title: 'Mental wellness deals', sub: 'Therapy & coaching with Valuehub Exchange', cta: 'Explore', bg: 'bg-pink-600', imgBg: 'bg-pink-500', expires: 'Limited slots' },
  ...
  beauty: {
    ...
    banners: [
      { title: 'Glow up with credits', sub: 'Salons & spas accept Valuehub Exchange', cta: 'Book Now', bg: 'bg-pink-500', imgBg: 'bg-pink-400', expires: 'Ongoing' },
  ...
  fitness: {
    ...
    banners: [
      { title: 'Train now, pay with credits', sub: 'Gyms & studios on Valuehub Exchange', cta: 'Find a Gym', bg: 'bg-orange-600', imgBg: 'bg-orange-500', expires: 'Ongoing' },
  ...
  mechanic: {
    ...
    banners: [
      { title: 'Car repairs with credits', sub: 'Trusted mechanics on Valuehub Exchange', cta: 'Find Mechanic', bg: 'bg-slate-600', imgBg: 'bg-slate-500', expires: 'Ongoing' },
  ...
  lawyer: {
    ...
    banners: [
      { title: 'Legal help, barter style', sub: 'Consult lawyers with Valuehub Exchange credits', cta: 'Find a Lawyer', bg: 'bg-slate-700', imgBg: 'bg-slate-600', expires: 'Ongoing' },
  ...
  tutor: {
    ...
    banners: [
      { title: 'Learn more, pay less', sub: 'Tutors & courses with Valuehub Exchange credits', cta: 'Find a Tutor', bg: 'bg-sky-600', imgBg: 'bg-sky-500', expires: 'Ongoing' },
  ...
  photographer: {
    ...
    banners: [
      { title: 'Capture moments with credits', sub: 'Book photographers on Valuehub Exchange', cta: 'Book Now', bg: 'bg-amber-700', imgBg: 'bg-amber-600', expires: 'Ongoing' },
